...
extension UIViewController {
    ...
    func addAnyButtonToRight(title:String?, image:UIImage?, action:@escaping EmptyClosure) {
        let button = UIButton.init(type: .system)
    ...
    func addAnyButtonsToRight(image1:UIImage?, image2:UIImage?, action1:@escaping EmptyClosure, action2:@escaping EmptyClosure) {
...
//    }
//
//    func addProfileEditButton(action:@escaping EmptyClosure) -> UIButton {
//        let button = UIButton.init(type: .system)
